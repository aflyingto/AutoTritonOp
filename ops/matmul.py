...
This is a Triton-Ascend implementation of matrix multiplication operation.
"""
...
def matmul_kernel(
    ...
    N,
    K,
    # The stride variables represent how much to increase `ptr` by when moving by 1
    ...
    msk_n = offs_bn < N
    # -----------------------------------------------------------
    # Iterate to compute a a block of the C matrix.
    ...
    # while `accumulator` is still in FP32!
    ...
    # Comment out the following lines to enable split workload to two vector cores
...
def matmul(a, b, activation=""):
    """
    Matrix multiplication function using Triton-Ascend kernel.
